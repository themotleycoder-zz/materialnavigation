...
import com.geekfamilyprojects.materialnavigation.adapter.CustomPagerAdapter;
import com.geekfamilyprojects.materialnavigation.fragment.CheeseListFragment;

import java.util.ArrayList;
import java.util.List;

public class SlidingTabViewActivity extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sliding_tabs_view);
    ...
    private void setupViewPager(ViewPager viewPager) {
        CustomPagerAdapter adapter = new CustomPagerAdapter(getSupportFragmentManager(), this);
